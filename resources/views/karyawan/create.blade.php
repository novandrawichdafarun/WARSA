<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800">Tambah Akun Kasir</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
                    ...
                    <div>
                        <p class="font-medium text-gray-800">Akun Kasir Baru</p>
                        <p class="text-xs text-gray-400">Kasir hanya bisa akses halaman POS dan riwayat transaksi</p>
                    </div>
                </div>
